...
│   │   └── 📄 0007_editedocrexample.py (1.3 KB)
│   ├── 📄 __init__.py
│   ├── 📄 admin.py (143 B)
│   ├── 📄 apps.py (219 B)
...
├── 📄 celerybeat-schedule.bak (91 B)
├── 📄 celerybeat-schedule.dat (1.5 KB)
├── 📄 celerybeat-schedule.dir (91 B)
├── 📄 manage.py (682 B)
├── 📄 requirements.txt (5.06 KB)
├── 📄 setup.ps1 (3.53 KB)
├── 📄 test.png (80.5 KB)
├── 📄 test.py (162 B)
├── 📄 tmp_signup_check.py (391 B)
└── 📄 tmp_signup_debug.py (391 B)
```
...
- [📄 ocr_api/migrations/0007_editedocrexample.py](#📄-ocr-api-migrations-0007-editedocrexample-py)
...
- [📄 setup.ps1](#📄-setup-ps1)
- [📄 test.py](#📄-test-py)
- [📄 tmp_signup_check.py](#📄-tmp-signup-check-py)
- [📄 tmp_signup_debug.py](#📄-tmp-signup-debug-py)
...
- **MD5**: `d1464bd31ef74453703b170c5b4df0a8`
- **SHA256**: `7f501dd452f928d680a10f1eb446b4bbdfa702b6466a2d507354ebb4a2afe2ed`
- **Encoding**: UTF-8

**File code content:**

```python
# Celery removed — no celery app exposed from core package.
...
- **Relative Path**: `core`
- **Created**: 2026-08-15 07:23:01 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 10:36:58 (Asia/Damascus / GMT+03:00)
...
### <a id="📄-ocr-api-migrations-0007-editedocrexample-py"></a>📄 `ocr_api/migrations/0007_editedocrexample.py`

**File Info:**
- **Size**: 1.3 KB
- **Extension**: `.py`
- **Language**: `python`
- **Location**: `ocr_api/migrations/0007_editedocrexample.py`
- **Relative Path**: `ocr_api/migrations`
- **Created**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **MD5**: `ce54b43f7bf9636057495fc7b71285a6`
- **SHA256**: `ce3050ef3b37b31349c6cdf398562d3f5d030f94cd2f9d46454937a46eca39ad`
- **Encoding**: ASCII
...
- **MD5**: `26ea6718019162dd7d5e3b11d338839e`
- **SHA256**: `a1271eae5d5f5f410f85142cfd4cfaef03dbb52d01febe15c80f5b9e5158daed`
- **Encoding**: ASCII
...
- **Created**: 2026-08-15 07:23:01 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 11:26:14 (Asia/Damascus / GMT+03:00)
- **MD5**: `c9fcfd4c55d9ce30481e5e8ebd7d1efa`
- **SHA256**: `7a96a80a233d4a1d5a0de66f50f4d8f4df893d959a9d8685a81dc48008def0c0`
- **Encoding**: ASCII
...
- **Created**: 2026-08-15 07:23:01 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 14:29:10 (Asia/Damascus / GMT+03:00)
- **MD5**: `333cb6f4403e4d4a767b0e4266b0e52d`
- **SHA256**: `b111e73a268e0a2d7e98ef1142d2f02bd1c6c12601b265543bb817c49f90f088`
- **Encoding**: ASCII
...
- **Relative Path**: `root`
- **Created**: 2026-08-15 07:23:01 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 09:23:00 (Asia/Damascus / GMT+03:00)
- **MD5**: `c8b725f8cfb1c3d9242b938f94843193`
- **SHA256**: `9e9b69964fb360dfc46213b36b4b4faa0e98d7a31744abaf54beae914c5efe9a`
- **Encoding**: UTF-16
...
 c y c l e r = = 0 . 1 2 . 1  
 d e b u g p y = = 1 . 8 . 1 7  
 d e c o r a t o r = = 5 . 2 . 1  
 D j a n g o = = 6 . 0 . 5  
 d j a n g o _ c e l e r y _ r e s u l t s = = 2 . 6 . 0  
 d j a n g o r e s t f r a m e w o r k = = 3 . 1 7 . 1  
 d n s p y t h o n = = 2 . 8 . 0  
 d o c u t i l s = = 0 . 2 2 . 4  
 e m a i l - v a l i d a t o r = = 1 . 3 . 1  
 e x e c u t i n g = = 2 . 2 . 1  
 e x p e c t r a = = 1 . 0 . 5  
 f i l e l o c k = = 3 . 2 0 . 1  
 F l a s k = = 2 . 3 . 2  
 F l a s k - J W T - E x t e n d e d = = 4 . 4 . 4  
 F l a s k - S Q L A l c h e m y = = 3 . 0 . 4  
 f o n t t o o l s = = 4 . 6 1 . 1  
 f s s p e c = = 2 0 2 5 . 1 2 . 0  
 g r e e n l e t = = 3 . 3 . 0  
 i d = = 1 . 5 . 0  
 i d n a = = 3 . 7  
 i p y k e r n e l = = 7 . 1 . 0  
 i p y t h o n = = 9 . 7 . 0  
 i p y t h o n _ p y g m e n t s _ l e x e r s = = 1 . 1 . 1  
 i t s d a n g e r o u s = = 2 . 2 . 0  
 j a r a c o . c l a s s e s = = 3 . 4 . 0  
 j a r a c o . c o n t e x t = = 6 . 1 . 0  
 j a r a c o . f u n c t o o l s = = 4 . 4 . 0  
 j e d i = = 0 . 1 9 . 2  
 J i n j a 2 = = 3 . 1 . 6  
 j o b l i b = = 1 . 5 . 3  
...
 k a g g l e = = 1 . 8 . 3  
 k a g g l e s d k = = 0 . 1 . 1 5  
 k e y r i n g = = 2 5 . 7 . 0  
...
 m a r s h m a l l o w - s q l a l c h e m y = = 0 . 2 9 . 0  
 m a t p l o t = = 0 . 1 . 9  
...
 S i m p l e W e b S o c k e t S e r v e r = = 0 . 1 . 2  
 s i x = = 1 . 1 6 . 0  
 s o u p s i e v e = = 2 . 5  
 S Q L A l c h e m y = = 2 . 0 . 4 5  
 s q l p a r s e = = 0 . 5 . 5  
 s t a c k - d a t a = = 0 . 6 . 3  
 s y m p y = = 1 . 1 4 . 0  
 t e x t - u n i d e c o d e = = 1 . 3  
 t h r e a d p o o l c t l = = 3 . 6 . 0  
 t o r c h = = 2 . 9 . 1  
 t o r c h a u d i o = = 2 . 9 . 1  
 t o r c h v i s i o n = = 0 . 2 4 . 1  
 t o r n a d o = = 6 . 5 . 2  
 t q d m = = 4 . 6 7 . 1  
 t r a i t l e t s = = 5 . 1 4 . 3  
 t w i n e = = 6 . 2 . 0  
 t y p e s - r e q u e s t s = = 2 . 3 2 . 4 . 2 0 2 6 0 1 0 7  
 t y p e s - t q d m = = 4 . 6 7 . 0 . 2 0 2 5 0 8 0 9  
 t y p i n g = = 3 . 7 . 4 . 3  
 t y p i n g _ e x t e n s i o n s = = 4 . 1 1 . 0  
 t z d a t a = = 2 0 2 6 . 2  
 t z l o c a l = = 5 . 3 . 1  
 u r l l i b 3 = = 2 . 2 . 1  
 u s h l e x = = 0 . 9 9 . 1  
 v i n e = = 5 . 1 . 0  
 w a i t r e s s = = 3 . 0 . 2  
 w c w i d t h = = 0 . 2 . 1 4  
 w e b e n c o d i n g s = = 0 . 5 . 1  
 w e b s o c k e t - c l i e n t = = 1 . 9 . 0  
 W e r k z e u g = = 3 . 1 . 5  
 
```
...
### <a id="📄-tmp-signup-check-py"></a>📄 `tmp_signup_check.py`

**File Info:**
- **Size**: 391 B
- **Extension**: `.py`
- **Language**: `python`
- **Location**: `tmp_signup_check.py`
- **Relative Path**: `root`
- **Created**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **MD5**: `4361cf4604f0e9a602d9324a2627b971`
- **SHA256**: `b4ebb1107b0afcddf22e78545e023a5986f88073ee07e8e592aec755523947fa`
...
### <a id="📄-tmp-signup-debug-py"></a>📄 `tmp_signup_debug.py`

**File Info:**
- **Size**: 391 B
- **Extension**: `.py`
- **Language**: `python`
- **Location**: `tmp_signup_debug.py`
- **Relative Path**: `root`
- **Created**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **Modified**: 2026-08-15 10:14:18 (Asia/Damascus / GMT+03:00)
- **MD5**: `4361cf4604f0e9a602d9324a2627b971`
